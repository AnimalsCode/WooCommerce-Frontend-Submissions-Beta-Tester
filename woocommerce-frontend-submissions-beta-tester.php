<?php
/**
 * Plugin Name: WooCommerce Frontend Submissions Beta Tester
 * Plugin URI: https://github.com/seb86/WooCommerce-Frontend-Submissions-Beta-Tester
 * Description: Run bleeding edge versions of WooCommerce Frontend Submissions from Github. This will replace your installed version of WooCommerce Frontend Submissions with the latest tagged release on Github - use with caution, and not on production sites. You have been warned.
 * Version: 1.0.0
...
if ( ! class_exists( 'WC_Frontend_Submissions_Beta_Tester' ) ) :

	/**
	 * WC_Frontend_Submissions_Beta_Tester Main Class
	 */
	class WC_Frontend_Submissions_Beta_Tester {
		...
		public function overrule_transients() {
			return ( defined( 'WC_FRONTEND_SUBMISSIONS_BETA_TESTER_FORCE_UPDATE' ) && WC_FRONTEND_SUBMISSIONS_BETA_TESTER_FORCE_UPDATE );
		}
		...
		public function upgrader_source_selection( $source, $remote_source, $upgrader ) {
			...
			if ( strstr( $source, '/seb86-woocommerce-' ) ) {
	...
	register_activation_hook( __FILE__, array( 'WC_Frontend_Submissions_Beta_Tester', 'activate' ) );

	add_action( 'admin_init', array( 'WC_Frontend_Submissions_Beta_Tester', 'instance' ) );
